...
const UploadVideo = () => {
    ...
    const uploadVideoThumbnail = (event) => {
        ...
        else if(videoTitle.length != 0 && isThumbnailAttached == true){
            ...
            <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
                ...
                <form className="mx-auto mt-12 max-w-xl sm:mt-12">
                    ...
                    {/* Preview Video File */}
                    {
                        ...
                        ?
                        <div className="sm:col-span-2">
                            <label htmlFor="video-file" className="block text-sm font-semibold leading-6 text-gray-900">Video Preview</label>
                            <video ref={videoRef} className="sm:w-[57rem] md:-ml-4 lg:-ml-0" width={1280} height={720} controls muted autoPlay>
